...
public class ModConfigs {
    ...
    @Entry(category = "Client Only", name = "Enable mod", require_restart = false)
    public static boolean __enable_mod = true;

    @Entry(category = "Client Only", name = "Enable Cloud Sync", require_restart = false)
    public static boolean _enable_cloud_sync = true;

    @Entry(category = "Client Only", name = "Enable dynamic light", require_restart = false)
    public static boolean enable_dynamiclight_compat = true;

    @Entry(category = "Client Only", name = "Hide backpack if invisible", require_restart = false)
    public static boolean hide_if_invisible = true;

    @Entry(category = "Server Only", name = "Hide items component data", require_restart = false)
